    ...
    def createMatlabBindings(self) -> None:
        ...
        def createBoilerPlate(headerFiles: List[str], helicsElementMapTuples) -> str:
            ...
            for h in headerFiles:
                boilerPlateStr = f"#include \"{h}\"\n"
            boilerPlateStr += "#include <mex.h>\n"
            boilerPlateStr += "#include <map>\n"
            ...
            boilerPlateStr += "\t}\n"
            boilerPlateStr += "}\n\n"
            boilerPlateStr += "static const std::map<std::string,int> wrapperFunctionMap{\n"
            ...
            boilerPlateStr += "\t}\n"
            boilerPlateStr += "\tint functionId = wrapperFunctionMap[std::string(mxArrayToString(*argv++))];\n"
